...
위와 같은 **6가지 항목**으로 나누고, 사용자는 각 항목을 **0~100 척도**로 평가하게 됩니다.
...
PC1과 직교하면서 그다음으로 **데이터가 퍼진 정도**가 큰 방향을 두 번째 주성분(PC2)으로 잡습니다. <br>

PCA의 원리는 "**PC1과 PC2만으로도** 데이터의 큰 흐름을 이해할 수 있다"이기 때문에  <br> 
...
> [!IMPORTANT]
> TLX의 6개 항목을 **다차원 상태**로 보고, PCA를 적용해 <strong>주요 성분 (=핵심 방향)</strong>만 남기는 아이디어를 구상했습니다. <br><br>
...
> 그에 맞는 답을 생성할 수 있기에, 본 프로젝트의 **조언 제시 모듈**에 적용하고자 했습니다.